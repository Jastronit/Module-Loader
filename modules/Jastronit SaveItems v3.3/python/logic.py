...
def logic_main_init(stop_event=None):
    # Ak verzia modloadera je nižšia ako 1.0.0, ukončenie kódu
    if main.MODLOADER_VERSION < (1, 0, 0):
        return
    ...
    if not DB_PATH or not os.path.exists(DB_PATH):
        log_to_console("[SaveItems] SCUM.db file not found. Please enter the path manually in config/path.ini.")
        return
